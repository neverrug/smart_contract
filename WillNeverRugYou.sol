...
contract WNRY is ERC20, Ownable {
    ...
    WNRYDividendTracker public dividendTracker;

    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    address public marketingWallet = 0xcca5466Ba719d2e15EAA0679D7F23d15b970dC2B;
    address public devWallet = 0xdadbEAb5CB3Ed6044654D12EAefF69dB14b19D2f;

    uint256 public swapTokensAtAmount = 2_000_000 * 10**9;

    //Anti-Dump
    uint256 public maxSellAmountPerCycle = 100_000_000 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(3,4,1,2);
    Taxes public sellTaxes = Taxes(3,4,1,2);
    ...
    constructor() ERC20("WillNeverRugYou", "WNRY") {

    	dividendTracker = new WNRYDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        WNRYDividendTracker newDividendTracker = WNRYDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "WNRY: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "WNRY: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "WNRY: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "WNRY: Cannot update gasForProcessing to same value");
...
contract WNRYDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("WNRY_Dividen_Tracker", "WNRY_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 10_000_000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "WNRY_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "WNRY_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "WNRY_Dividend_Tracker: Cannot update claimWait to same value");
